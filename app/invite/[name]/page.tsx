...
export default function InvitationPage() {
  ...
  return (
    <div className="h-screen w-screen fixed inset-0 overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="absolute top-10 left-5 w-40 h-40 bg-red-600/20 rounded-full filter blur-3xl animate-blob" />
      <div className="absolute top-20 right-5 w-40 h-40 bg-amber-600/20 rounded-full filter blur-3xl animate-blob animation-delay-2000" />
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6 py-6">
                  <motion.div
                    ...
                    className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full mb-3"
                  >
                  ...
                  <motion.h1
                    ...
                    className="text-5xl font-bold text-white leading-tight relative"
                    style={{
